    ...
    <div className="h-screen flex flex-col items-center">
      ...
      <main className="container px-4 sm:px-20 flex items-center flex-col grow">
        <div className="mt-6 mb-12 text-gray-900 font-normal">
          <p className="mb-6">
            この利用規約（以下、「本規約」といいます。）は、Pokemon Rental Teams
            Search（以下、「本サービス」といいます。）の利用条件を定めるものです。ユーザーの皆さま（以下、「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。
          </p>
          <h3 className="text-lg font-medium">第1条（適用）</h3>
          ...
          <h3 className="text-lg font-medium">第2条（禁止事項）</h3>
          <p>
          ...
          <ol className="mb-6 list-decimal ml-8">
            ...
            <li>
              本サービスが許諾しないサービス上での宣伝，広告，勧誘，または営業行為
            </li>
          ...
          <h3 className="text-lg font-medium">第4条（著作権等知的財産権)</h3>
          <ol className="mb-6 list-decimal ml-8">
            <li>
              本サービス内の文章、写真その他の知的財産権は本サービスに帰属します。
            </li>
            <li>
          ...
          <h3 className="text-lg font-medium">第11条（準拠法・裁判管轄）</h3>
          <ol className="mb-6 list-decimal ml-8">
          ...
          <p className="mb-6">（2023年1月15日 制定）</p>
        </div>
        <div>
