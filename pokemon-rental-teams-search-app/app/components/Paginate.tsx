  ...
  return (
    <nav aria-label="Page navigation">
      <ul className="inline-flex items-center -space-x-px">
        <li>
          <Link
            className={`block px-3 py-2 ml-0 leading-tight  bg-white border border-gray-300 rounded-l-md sm:rounded-l-lg ${
              previousDisabled
        ...
        <li>
          <Link
            className={`block px-3 py-2 ml-0 leading-tight  bg-white border border-gray-300 rounded-r-md sm:rounded-r-lg ${
              nextDisabled
                ? "text-gray-300 pointer-events-none"
                : "text-gray-500 hover:bg-gray-100 hover:text-gray-700"
            }`}
